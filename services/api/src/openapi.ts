const jobPostingSchema = {
  ...
  properties: {
    ...
    isHybrid: { type: "boolean", nullable: true },
    detectedCountry: { type: "string", nullable: true },
    isUSLikely: { type: "boolean", nullable: true },
    matchedUsLocality: { type: "string", nullable: true },
    matchedUsState: { type: "string", nullable: true },
    geoDecision: { type: "string", enum: ["keep", "drop", "review"], nullable: true },
    geoConfidence: { type: "string", enum: ["high", "medium", "low"], nullable: true },
    geoScore: { type: "number", nullable: true },
    geoReasons: { type: "array", items: { type: "string" } },
