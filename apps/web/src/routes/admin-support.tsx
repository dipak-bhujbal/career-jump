  ...
  return (
    <>
      ...
      <AdminPageFrame
        ...
        eyebrow="User Ops"
        title="Handle support traffic without leaving the admin workspace"
        description="Filter the queue, inspect ticket threads, and send admin replies while keeping the broader operational navigation one click away."
      >
